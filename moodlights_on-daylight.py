...
client.publish("moodlight/1/red","666")
client.publish("moodlight/2/red","666")
client.publish("moodlight/3/red","666")
client.publish("moodlight/4/red","666")
client.publish("moodlight/5/red","666")
client.publish("moodlight/6/red","666")
